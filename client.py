# basis of this taken from project 3 client
...
def upload(baseurl):
  ...
  try:
    ...
    data = {"filename": local_filename, "data": datastr, 'caption': caption}
...
#
try:
  print('** Welcome to our photo sharing app! **')
  print()
  ...
  #
  config_file = 'photo-media-app-client-config.ini'
